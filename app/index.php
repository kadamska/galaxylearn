...
<div class="row welcome-home">
	<img class="home-background" src="img/changetime.jpg" onclick="window.location.href='<?php echo 'http://'.$_SERVER['SERVER_NAME'] . dirname($_SERVER['REQUEST_URI']); ?>/controlpanel.php'" />
